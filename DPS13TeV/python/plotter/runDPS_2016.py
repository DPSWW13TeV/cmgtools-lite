...
#/afs/cern.ch/user/p/peruzzi/work/tthtrees/TREES_TTH_190418_Fall17_skim2lss3l/8_vtxWeight2017_v1/evVarFriend_WW_DPS.root
    ...
    targetdir = '/eos/user/a/anmehta/www/{date}{pf}2016_SMP_PAG'.format(date=date, pf=('-'+postfix if postfix else '') ) 
    ...
    for bdt in ['wz']:
        for ich,ch in enumerate(loop):
            ...
            drawvars=['chargecon2','chargecon1','met','nVert','dphil2met','pt1','mll','mtll','mt1','mt2','dphiLep','pt2','eta_sum','dphilll2','etaprod','mt2ll','dphil2met']#,'nVert','njetsclean','jetclean_csva']
