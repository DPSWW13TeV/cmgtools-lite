...
for sample in ["WZToLNuJJ_01j_LO_EWdim6NLO","WWToLNuJJ_01j_LO_EWdim6NLO","WWToLNujj_01j_SMEFT_LO","WZToLNujj_01j_SMEFT_LO"]:
    print("sample ",sample)
    os.system("ls -lrtch  %s/%s/*root | wc -l "%(eosDir,sample))
