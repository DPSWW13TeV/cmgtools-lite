...
allvars= topCR #theWVultimateset #+moreak8jetvars MConly+#newVars+lepvars+WVvars+eventvars 
...
pf="fit2data"
for dW in ["topCR"]: #topCR","wjCR"]: #"SR","topCR","wjCR"]:#"wjCR","SR","topCR"]: #topCR","wjCR","SR"]: #," inclB"]: #,"topCR"]: #,"SR"]:
    for nl in ["1"]: #"1,2".split(","):
        for cat in ["boosted"]: #,"resolved"]: #.split(","):
            for yr in ["2018"]: #2016,2017,2018".split(","):
                for lep in ["el","mu"]:#"el","mu"]: #,"onelep"]:
                    for iVar in allvars:
