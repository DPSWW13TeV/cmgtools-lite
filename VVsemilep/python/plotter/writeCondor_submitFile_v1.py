...
ops_smeft=['cll1','cG','cHd','cHDD','cHj3','cjj38','cHWtil','cHj1','cju1','cuu8','cdd8','cuu1','cdd1','cHG','cHe','cHl1', 'cHWB', 'cHl3', 'cju8', 'cjd1', 'clu',  'cWtil','clj3', 'cjj11','cHu',  'ceu','cHWBtil','ced','clj1','cjj18','cGtil','cW','cld','cje', 'cjd8','cud8','cud1','cjj31','cHGtil']
ops_eft=['Odd_cw','Odd_c3w','cw','c3w','cb']

Mops_eft=[i+'M'+j for i in ops_eft for j in ops_eft if i != j]
Mops_smeft=[i+'M'+j for i in ops_smeft for j in ops_smeft if i != j]
list_ops={'smeft':ops_smeft,'eft':ops_eft}
