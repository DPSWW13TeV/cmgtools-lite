...
#year=sys.argv[2]
pf=""
years=["2018","2016APV","2016","2017"] #,"fullRun2"] #,"all"] 
#years.append(year)
...
for sel in ["topCR_incl","wjCR_lo","wjCR_hi","sig_lo","sig_hi"]: #"wjCR_incl","sig_incl"]: # #"wjCR_incl","sig_incl"]:#]: #, #,"topCR_incl","topCR_lo","topCR_hi"]
   for cat in ["boosted"]: 
