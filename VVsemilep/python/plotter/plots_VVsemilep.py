...
def makesimpleplots(year,useDressed=True):
    ...
    bareNano    = False
    cutFlow     = False
    processes   = ['WW','aTGC_SM', 'aTGC_incl']#,'aTGC','aTGC_incl']##'WJetsToLNu']#'ttmtt1ktoinf','ttmttp7kto1k','ttsemi']#'WJetsToLNu']#'WW','aTGC']#'ttmtt1ktoinf','ttmttp7kto1k','Rwtttsemi']#'ttsemi']
