...
eventvars   = ['nVert','met','metphi','puppimet','puppimetphi']
jetvars     = ['jetpt','jeteta','njets30','jetmass']
fatjetvars  = ['fatjetpt','fatjeteta','nfatjets','jetmass','fatjetsDrop_mass','fatjetpNet_mas']
lepvars     = ['nLepGood','lep1_pt','lep2_pt']

bdtiv      = ['conept1','conept2','met','mt2ll','mt1','mtll','etasum','etaprod','dphill','dphil2met','dphilll2']
allvars    = eventvars+jetvars+fatjetvars+lepvars
