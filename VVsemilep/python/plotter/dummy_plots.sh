...
if [[ $# -eq 6 ]]; then
    python plots_VVsemilep.py --results --sel SR --dW plots --year ${2} --nLep ${3} --finalState ${4} --pv ${5}  --sel ${6}
else
    python plots_VVsemilep.py --results --sel SR --dW plots --year ${2} --nLep ${3} --finalState ${4} --pv ${5}  --sel ${6} --pf ${7}
fi
