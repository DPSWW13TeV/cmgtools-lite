...
if [[ $# -eq 7 ]]; then
    python plots_VVsemilep.py --results --sel SR --dW plots --year ${2} --nLep ${3} --finalState ${4} --pv ${5}  --sel ${6} --lf ${7} --applylepSFs
else
    python plots_VVsemilep.py --results --sel SR --dW plots --year ${2} --nLep ${3} --finalState ${4} --pv ${5}  --sel ${6} --lf  ${7} --pf ${8} --applylepSFs
fi
