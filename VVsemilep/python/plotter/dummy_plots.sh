...
if [[ $# -eq 6 ]]; then
    python plots_VVsemilep.py --results --dW plots --year ${2} --nLep 1 --finalState ${3} --pv ${6}  --sel ${4} --lf ${5} --applylepSFs   --pf nEvt_SIGfix  --dCF --doWJ  ## --dCF ##--runblind 
    python plots_VVsemilep.py --results --dW plots --year ${2} --nLep 1 --finalState ${3} --pv ${6}  --sel ${4} --lf ${5} --applylepSFs   --pf nEvt_SIGfix  --dCF
else
