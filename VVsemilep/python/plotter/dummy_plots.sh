...
if [[ $# -eq 6 ]]; then
    python plots_VVsemilep.py --results --dW plots --year ${2} --nLep 1 --finalState ${3} --pv ${6}  --sel ${4} --lf ${5} --pD /eos/user/a/anmehta/www/VVsemilep/ --applylepSFs --dCF #--pf FC #--doWJ --pf FC ##--dCF ##--runblind 
