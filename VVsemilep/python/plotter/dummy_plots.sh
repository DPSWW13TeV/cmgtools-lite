...
if [[ $# -eq 7 ]]; then
    python plots_VVsemilep.py --results --dW plots --year ${2} --nLep ${3} --finalState ${4} --pv ${5}  --sel ${6} --lf ${7} --applylepSFs #--dCF
else
    python plots_VVsemilep.py --results --dW plots --year ${2} --nLep ${3} --finalState ${4} --pv ${5}  --sel ${6} --lf ${7} --pf ${8} --applylepSFs #--dCF
fi
