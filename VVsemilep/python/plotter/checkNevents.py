...
#eospath="/eos/cms/store/cmst3/group/dpsww/NanoTrees_v9_vvsemilep_13112024" #06012023" #_skimmed"
...
for x in glob(basepath+"/*.root"):
    ...
    if "Run20" in proc and frnds_dir not in ['1_recl','3_ak8_sdm45','0_wjest_v7']: continue
