...
def commandsToRun(dc,pf,plots_odir,WC):
    ...
    os.system("combine -M MultiDimFit model_%s.root  --algo=grid --points 2000  -m 125  -t -1  --redefineSignalPOIs k_%s  --freezeParameters r --setParameters r=1  --setParameterRanges  k_%s=-4,4 --X-rtd MINIMIZER_MaxCalls=400000  --cminDefaultMinimizerTolerance 0.5 --cminDefaultMinimizerStrategy 0 --X-rtd SIMNLL_NO_LEE --X-rtd NO_ADDNLL_FASTEXIT  --alignEdges 1  "%(dCard_str_wpath,WC,WC)) #--verbose 1
