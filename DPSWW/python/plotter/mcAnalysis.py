...
from CMGTools.DPSWW.plotter.figuresOfMerit import FOM_BY_NAME
from CMGTools.DPSWW.plotter.histoWithNuisances import *
           ...
           ## If we have a user-defined list of processes as signal
            ...
            if self.variationsFile:
                for var in self.variationsFile.uncertainty():
                    if var.unc_type == 'altSample': continue ##am
            ...
            genSumWeightName = extra["genSumWeightName"] if "genSumWeightName" in extra else "genEventSumw_" ### FIXME if changing nanoaod version
            is_w = -1
            pname0 = pname
            for cname in cnames:
                skipMe = False
