...
band.GetXaxis().SetTitleFont(42);    band.GetXaxis().SetLabelSize(0.135);    band.GetXaxis().SetTitleSize(0.15);
...
band.GetYaxis().SetRangeUser(0.5,3.0 if fit == "fit_s" else 3.5);  
band.GetYaxis().SetNdivisions(607);    ROOT.gStyle.SetErrorX(0.5); 
...
#line2 = ROOT.TLine(nbinsx,0.5,nbinsx,3);        line22.SetLineColor(1);   line22.SetLineWidth(1);   line22.SetLineStyle(2);
#line32 = ROOT.TLine(nbinsx*2,0.5,nbinsx*2,3);    line32.SetLineColor(1);   line32.SetLineWidth(1);   line32.SetLineStyle(2);
#line42 = ROOT.TLine(nbinsx*3,0.5,nbinsx*3,3);    line42.SetLineColor(1);   line42.SetLineWidth(1);   line42.SetLineStyle(2);
...
c1_1.Update();
legend1 = ROOT.TLegend(0.32,0.82,0.47,0.92); #,NULL,"brNDC");
...
hs.GetYaxis().SetLabelSize(0.06);    hs.GetYaxis().SetTitleSize(0.075);    hs.GetYaxis().SetTitleOffset(0.65);
...
t3a = drawSLatex(0.67,0.94,"138 fb^{#minus1} (13 TeV)",0.085);

t4a = drawSLatex(0.6,0.50,"#mu^{#plus}#mu^{#plus}",0.085);
t5a = drawSLatex(0.8,0.50,"#mu^{#minus}#mu^{#minus}",0.085);
t6a = drawSLatex(0.2,0.50,"e^{#plus}#mu^{#plus}",0.085);
t7a = drawSLatex(0.4,0.50,"e^{#minus}#mu^{#minus}",0.085);


Canv.Update();
    
Canv.Print("/afs/cern.ch/work/a/anmehta/public/paper_run2_postFR/SMP-21-013//Figure_002.pdf")
Canv.Print("/afs/cern.ch/work/a/anmehta/public/paper_run2_postFR/SMP-21-013//Figure_002.png")
...
#Canv.Print("/eos/user/a/anmehta/www/DPSWW_v2/10feb/superplot_%s_withratio_postFR"%fit + '.pdf')
#Canv.Print("/eos/user/a/anmehta/www/DPSWW_v2/10feb/superplot_%s_withratio_postFR"%fit + '.png')
