...
for iFile in `ls ${path}/*.txt`; do
    cat $iFile > dummy.txt
    #echo ${iFile}
    sed -e 's/fr_2018.root : FR_mva085_mu/fr_2018_MVA_mupt90_elpt70.root : FR_mva090_mu/g;s/fr_2017.root : FR_mva085_mu/fr_2017_MVA_mupt90_elpt70.root : FR_mva090_mu/g;s/fr_2018_MVA_mupt85_elpt70.root : FR_mva070_el/fr_2018_MVA_mupt90_elpt70.root : FR_mva070_el/g' dummy.txt > $iFile
