...
Trees='signal_fullstats/' #'NanoTrees_v7_dpsww_04092020' # trees (unskimmed)
skimmedTrees='signal_fullstats_skim2lss' #NanoTrees_v7_dpsww_skim2lss' #
Friends_recl_unskimmed='2_recl'

years=("2017") # "2018") # "2016")
frnds=("dpsbdt_neu_ssnoeebkg_afacdps_unclEn" "dpsbdt_neu_ssnoeebkg_afacdps") #"postFSRinfo" "4_scalefactors" "3_tauCount" "0_jmeUnc_v2" "puWts" "muPrefiring" "2_btag_SFs" "nnpdf_rms" "dpsbdt_neu_ssnoeebkg_afacdps_unclEn" "dpsbdt_neu_ssnoeebkg_afacdps")
for yr in "${years[@]}"
do
