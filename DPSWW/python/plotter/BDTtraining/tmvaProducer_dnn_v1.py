...
##amfrom tensorflow import keras 
##amfrom tensorflow.keras.models import Sequential
##amfrom tensorflow.keras.layers import Dense, Activation
##amfrom tensorflow.keras.optimizers import SGD
##amfrom tensorflow.keras.optimizers import Adam
##amfrom tensorflow.keras.optimizers import Adamax
##amfrom tensorflow.keras.optimizers import Nadam
##amfrom tensorflow.keras.optimizers import Adadelta
##amfrom tensorflow.keras.optimizers import Adagrad
...
def train_classification(year,bkg,useconept,usefr,moretxt):
    ...
    commonstr="dnn_noee_dpsvs"+"_"+bkg+"_"+moretxt+year+pf+pff1+pff
    # Setup TMVA
    TMVA.Tools.Instance()
    ...
    # Define model
    ##ammodel = Sequential()
    ##ammodel.add(Dense(30, activation='relu', input_dim=11))
    ##ammodel.add(Dense(2, activation='sigmoid'))
    ##am# Set loss and optimizer
    ##ammodel.compile(loss='categorical_crossentropy',
    ##am              optimizer=Adam(lr=0.001), metrics=['accuracy', ])
    ##am
    ##am# Store model to file
    ##ammodel.save('model_%s%s%s%s%s%s.h5'%(bkg,moretxt,year,pf,pff1,pff))
    ##ammodel.summary()
    
    # Book methods
    #factory.BookMethod(DL, TMVA.Types.kFisher, 'Fisher',
    #               '!H:!V:Fisher:VarTransform=D,G')
    #factory.BookMethod(DL, TMVA.Types.kPyKeras, 'PyKeras',
    #                   'H:V:VarTransform=D,G:FilenameModel=model_%s%s%s%s%s%s.h5:NumEpochs=20:BatchSize=32'%(bkg,moretxt,year,pf,pff1,pff))
    ...
    ##amfactory.BookMethod(DL,ROOT.TMVA.Types.kBDT, 'BDT',
    ##am                   ':'.join([
    ##am                       '!H',
    ##am                       '!V',
    ##am                       'NTrees=450',
    ##am                       'MinNodeSize=2.5%',
    ##am                       'MaxDepth=2',
    ##am                       'BoostType=AdaBoost',
    ##am                       'AdaBoostBeta=0.5'
    ##am                       'UseBaggedBoost',
    ##am                       'BaggedSampleFraction=0.50',
    ##am                       'nCuts=20',
    ##am                       'CreateMVAPdfs',
    ##am                       'SeparationType=GiniIndex',
    ##am                       'NegWeightTreatment=IgnoreNegWeightsInTraining'
    ##am                   ]))
##
