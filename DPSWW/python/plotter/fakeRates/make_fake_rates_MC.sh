...
if [[ "$*" == "" ]]; then WPs="080iRun2v1.0"; else WPs="$1"; fi; ## xcheck
...
for WP in $WPs; do
	...
	VETOCONVERSIONS="LepGood_mcPromptGamma==0"
        case $WP in 
            000*) WNUM="0.00" ;; 030*) WNUM="0.30" ;; 060*) WNUM="0.60" ;;  065*) WNUM="0.65" ;;  070*) WNUM="0.70" ;;
            075*) WNUM="0.75" ;; 080*) WNUM="0.80" ;; 085*) WNUM="0.85" ;;  090*) WNUM="0.90" ;;  095*) WNUM="0.95" ;;
	...
	case $WP in
	    ...
	    *ptJ95*)    ptJI="ptJI95";;
        ...
        B0="$BASE -P $T fakeRates/lepton-fr/make_fake_rates_sels.txt fakeRates/lepton-fr/make_fake_rates_xvars.txt --groupBy cut --sP ${Num} " 
        #B0="$B0 --legend=TR --showRatio --ratioRange 0.41 1.59   --yrange 0 0.20 " 
        B0="$B0 --legend=TR --showRatio --ratioRange 0.00 1.99   --yrange 0 0.35 " 
	B1="${PLOTTER} -P $T fakeRates/lepton-fr/make_fake_rates_plots.txt"
