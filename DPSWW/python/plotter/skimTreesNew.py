#!/usr/bin/env python
#from mcPlots import *
from CMGTools.DPSWW.plotter.mcAnalysis import MCAnalysis, CutsFile, addMCAnalysisOptions, scalarToVector
...
if __name__ == "__main__":
    ...
    if options.skimFriends and not (options.pretend or options.justcount):
        skimFTrees = os.path.expandvars("$CMSSW_BASE/src/CMGTools/DPSWW/python/plotter/skimFTreesNew.py")
