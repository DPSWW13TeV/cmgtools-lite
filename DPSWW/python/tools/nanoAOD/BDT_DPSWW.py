...
class BDT_DPSWW(Module):
    def __init__(self,year):
        ...
        print year
        self._vars = [
            ##amMVAVar("Lep1_conept",       func = lambda ev : ev.Lep1_conept ),
            ##amMVAVar("Lep2_conept",       func = lambda ev : ev.Lep2_conept ),
            MVAVar("Lep1_pt",       func = lambda ev : ev.Lep1_pt ),
            MVAVar("Lep2_pt",       func = lambda ev : ev.Lep2_pt ),
        ...
        if self.year == 2016:
            ...
            wts_wz_amc = baseDir+'dataset_muWP90_elWP70_2017_wz_amc_withpt/weights/TMVAClassification_BDTG.weights.xml'
            wts_wz_pow = baseDir+'dataset_muWP90_elWP70_2017_wz_pow_withpt/weights/TMVAClassification_BDTG.weights.xml'
            wts_fakes  = baseDir+'dataset_muWP90_elWP70_2017_fakes_withpt/weights/TMVAClassification_BDTG.weights.xml'
            #        wts_multiC  = baseDir+'BDTtraining/dataset_multiclass/weights/TMVAMutliClass_BDTG.weights.xml'
