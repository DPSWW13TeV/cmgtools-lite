...
if flavor == "Muon":
    ...
    DatasetsAndTriggers.append( ("EGamma",     triggerGroups_dict["Trigger_1e"][year]) if year == 2018 else
...
modules = [ autoPuWeight , xsecTag, addTnpTree(year,flavor) ] 
cut = 'n%s > 1'%flavor
...
branchsel_out = os.environ['CMSSW_BASE']+"/src/CMGTools/DPSWW/python/tools/nanoAOD/branchsel_out.txt"
